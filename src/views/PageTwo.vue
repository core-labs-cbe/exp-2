...
<template class="app">
  <header style="padding: 20px">
    ...
    <p>To further finetune the identified verbs and to convert 
      them to a programmable format, identify the relevant 
      functions for the given verb phrases by dragging and 
      dropping.</p>
  </header>
  <main>
