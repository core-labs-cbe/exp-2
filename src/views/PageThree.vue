...
<template>
  <header style="padding: 30px">
    <h1>
      Step 4: Completing the time sequence diagram
    </h1>

    <p>
      Now that verb phrases have been identified and fine tuned, 
      we can move on to generating the time sequence diagram. 
      Identify the correct verb at each point from the list of 
      verbs given above and write it in the provided blank.
    </p>
  </header>
...
12 [Key HandedOver] : -->
        <div class="row" style="margin-top:35px">
          <div class="codebox" style="max-width: 350px;" :style="{ display: display[0] }">
            Fill in the correct answer from the list above to complete the sequence diagram
            <br>
            <br>
            1. <input v-model="one">
